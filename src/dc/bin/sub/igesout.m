...
%   seem to work fine.  However, it may be useful for a user to make
%   modifications to some of these parameters.
%
...
%   only tested with ProE, and seemed to work fine for each of the entities
%   described above.  If you have any problems, please send feedback.
%
%   Example
